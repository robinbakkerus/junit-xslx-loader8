...
public class XlsxConfig {
    ...
    private static List<SimpleDateFormat> makeDefDateFormats() {
        final List<SimpleDateFormat> r = new ArrayList<SimpleDateFormat>();
    ...
    public static void readFromXlsx(final String filename) {
        final Xlsx xlsx = new Xlsx(filename);
     ...
     */
    public static void setDateFormats(final List<SimpleDateFormat> dateFormats) {
     ...
     *            List<SimpleDateFormat>
     */
    public static void setAliases(final List<XlsxAlias> aliases) {
